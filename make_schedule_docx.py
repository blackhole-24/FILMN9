...
add_para('작성일: 2026-05-29(금) · 작성자: 이형주', size=9, color=(120, 120, 120))
doc.add_paragraph()
...
DAYS = [
        ...
        "sections": [
            {
                ...
                "rows": [
                    ...
                    ("5", "B", "ui_payload 통합 사전 협의 (태상님 DM)", "스키마·필드 정합 확인", "0.5h"),
                ],
            },
        ],
    },
        ...
        "sections": [
            {
                ...
                "rows": [
                    ...
                    ("2", "A", "히스토리브리핑 검증 프로그램 v1", "휘주님 MongoDB 2,526docs 무결성·중복·NULL 검증", "3.0h"),
        ...
        "sections": [
            {
                ...
                "rows": [
                    ...
                    ("4", "B", "ui_payload JSON → valuations 테이블 적재", "태상님 산출물 통합", "2.0h"),
    ...
    },
    {
        ...
        "sections": [
            ...
            {
                "header": "🌙 오전 9시 이후 — AWS 통합 (형주·태상·휘주·소희 합류)",
                "rows": [
                    ("4", "C", "AWS 통합 킥오프", "", "0.5h"),
