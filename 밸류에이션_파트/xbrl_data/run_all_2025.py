...
from xbrl_data import extract_company

def run_automation(csv_file="전종목리스트.csv", target_year=2025, out_dir="./output_json"):
    # 1. 결과물을 저장할 폴더 생성
    ...
    print(f"총 대상: {total_count}건 | 실패: {len(failed_companies)}건")
...
if __name__ == "__main__":
    ...
    run_automation(csv_file="전종목리스트.csv", target_year=2025, out_dir="./xbrl_results")