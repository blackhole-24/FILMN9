...
# ═════════════════════════════════════════════════════════════════════════════
REPORT_TYPES = [
    "annual",     # 사업보고서   (회계연도 종료 +90일 / 3월말)
    "Q1",         # 1분기보고서  (분기말 +45일 / 5월 중순)
...
RAG_DIR     = Path(r"C:\Users\Admin\Desktop\DART\RAG")           # 임베딩용 JSONL 출력
RAW_DIR     = Path(r"C:\Users\Admin\Desktop\DART\raw")           # 원본·정제 XML 보관
