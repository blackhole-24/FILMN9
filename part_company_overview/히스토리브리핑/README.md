...
`FILMN9/part_company_overview/히스토리브리핑/` — 전체 프로젝트 중 **연 1회 사업보고서 자동화** 담당.
...
| 작업 | 담당 | 관련 폴더 |
|------|------|----------|
| 자동화 코드 (연 1회) | 본인 | `part_company_overview/히스토리브리핑/` (이 폴더) |
| MongoDB Atlas 운영 | 재무정보 파트 | (인프라) |
| FastAPI 백엔드 | 팀원 | `api/` |
| 프런트엔드 (Next.js) | 팀원 | `frontend/` |
| 화면 디자인 / 데이터 시각화 | 팀원 | `frontend/` |
